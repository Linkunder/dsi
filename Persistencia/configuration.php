...
$configuration['db']	= 'matchday'; 		//	database name
...
//plugin settings
$configuration['plugins_path'] = 'D:\xampp\htdocs\dsi\Persistencia\plugins';  //absolute path to plugins folder, e.g c:/mycode/test/plugins or /home/phpobj/public_html/plugins
